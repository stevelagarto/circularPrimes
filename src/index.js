...
var getError = function (resultList) {
  if (resultList === null) { return 'Please, enter a number between 0 and 999999'; } else if (input.value === '') { return 'Insert a number'; } else if (Number(input.value) < 2) { return 'No results, try other number'; }
